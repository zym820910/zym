    ...
    init : function(){
		...
		this.startBtn = new Ext.Button({
            ...
            template: new Ext.Template(
				...
				'<td class="ux-startbutton-left"><i>&#160;</i></td><td class="ux-startbutton-center">'+
				'<em unselectable="on"><button class="x-btn-text" type="{1}" style="height:30px;">{0}</button></em>'+
				'</td><td class="ux-startbutton-right"><i>&#160;</i></td>',
				"</tr></tbody></table>")
        });
...
Ext.ux.TaskBar.TaskButton = function(win, el){
    ...
    Ext.ux.TaskBar.TaskButton.superclass.constructor.call(this, {
        ...
        template: new Ext.Template(
			'<table border="0" cellpadding="0" cellspacing="0" class="x-btn-wrap"><tbody><tr>',
			'<td class="ux-taskbutton-left"><i>&#160;</i></td><td class="ux-taskbutton-center">'+
			'<em unselectable="on"><button class="x-btn-text" type="{1}" style="height:28px;">{0}</button></em>'+
			'</td><td class="ux-taskbutton-right"><i>&#160;</i></td>',
			"</tr></tbody></table>")
    });
};

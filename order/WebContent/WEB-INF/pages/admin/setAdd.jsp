...
<BODY  class="mainbg">
<div class="maintop">套餐管理-套餐添加</div>
		<s:form id="form1" action="set_create" method="post" theme="simple">
	...
	<fieldset style="width:800px"><legend> <font color="#000000" size="-1">基本信息</font>
							...
							<table width=“780px”>
								<tr>
									...
									<td><s:textfield maxlength="5" size="10" onkeyup="value=value.replace(/[^\w\.\/]/ig,'')"
										onpaste="return   !clipboardData.getData('text').match(/[^w-]/)"  
									    ondragenter="return false" style="ime-mode:disabled" 
									    onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))" name="pkg.packageNo" />
									</td>
								...
								<tr>
									...
									<td><s:select id="packageType" name="pkg.packageType" list="typeList" listKey="value" listValue="label" style="width:93px"/></td>
									<td class="tdarrow">超出流量资费：</td>
									<td><s:textfield maxlength="6" size="6" id="feeMb"
										onpaste="return !clipboardData.getData('text').match(/[^w-]/)"  
										ondragenter="return false" style="ime-mode:disabled" 
										onkeyup = "this.value=/^\d+\.?\d{0,2}$/.test(this.value) ? this.value : ''"
										name="pkg.feePerMbIfExceed" onblur="check(this.value,'超出流量资费','1')" />元/MB
									</td>
									<td class="tdarrow">超出时长资费：</td>
								...
								<tr>
									...
									<td><s:textfield maxlength="11" size="10" readonly="true" id="moneyPreCharged" 
										onkeyup="value=value.replace(/[^\d]/g,'')"
										onpaste="return   !clipboardData.getData('text').match(/[^w-]/)"  
	...
	<fieldset style="width:800px"><legend> <font color="#000000" size="-1">分级信息</font>
							...
							<table width="780px">
									...
									<tr>
										...
										<td><s:select id="pkg.ifMultiGrades" name="pkg.ifMultiGrades" list="setGradesList" listKey="value" listValue="label" style="width:100px"/>
										</td>
										<td colspan="5">&nbsp;</td>
									</tr>
									<tr height="10px"/>
			...
			<span><input type="button" value="保存"  class="button2_max" onclick="saveSet();"/></span>

...
<s:hidden name="roleid" id="id"></s:hidden>
<div class="right" style="width: 92%;">
	  ...
	  <input name="Submit" type="button" onclick="javascript:window.location='role_detail.action?id=' + <s:property value='roleid'/>" class="button2_max" value="<s:text name='user.outeruser.back'/>" />
<!--	  <div class="line"></div>-->
<!--	  <div id="tabs">-->
<!--	  	<ul>-->

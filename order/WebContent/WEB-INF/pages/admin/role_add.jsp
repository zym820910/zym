...
<div class="right" style="width: 92%;">
  <h1><s:text name="system.role.add"/></h1>
  <div class="table">
...
<table width="92%"  border="0" cellspacing="0" cellpadding="0">
    ...
    <input name="Submit" type="button" onclick="javascript:window.location='role_list.action'"  class="button2" value="<s:text name='system.user.cancleBtn'/>" /> 
